...
import { Check, Info, Calendar, Users, Star, ArrowLeft } from "lucide-react";
                  ...
                  >
                    ...
                    <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100 flex gap-4">
                      ...
                      <p className="text-blue-800 text-xs md:text-sm">
                        <strong>Requirement:</strong> Please bring your ID card,
                        sunblock, and comfortable walking shoes. Pickup is
                        included from hotels in Da Nang city center.
                      </p>
                    </div>
                  </motion.div>
                )}
