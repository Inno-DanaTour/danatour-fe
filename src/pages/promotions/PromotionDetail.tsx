...
const PromotionDetail: React.FC = () => {
          ...
          {deleteResult === "DELETED" ? (
            <>
              ...
              <p className="text-gray-500">
                Mã khuyến mãi đã được xóa vĩnh viễn khỏi hệ thống.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-gray-500">
                Mã đã được sử dụng bởi khách hàng, nên đã được{" "}
                <strong>vô hiệu hóa</strong> thay thế để bảo toàn lịch sử đặt
                tour.
              </p>
            </>
          )}
  ...
  return (
    <div className="min-h-screen bg-transparent pb-20">
      ...
      <main
        className={`${isAdminView ? "pt-8" : "pt-24 md:pt-32"} px-4 md:px-6 max-w-5xl mx-auto`}
      >
        {/* Navigation & Actions */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <button
              ...
              className={`flex-1 md:flex-none px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                promotion.isActive
          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row justify-between gap-8 mb-12">
              <div className="flex-1">
                ...
                <p className="text-xl text-gray-400 font-mono tracking-[0.2em]">
                  {promotion.code}
                </p>
              </div>
              ...
              <div className="bg-primary text-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-primary/20 flex flex-col justify-center items-center md:items-start min-w-[240px]">
                ...
                {promotion.maxDiscountAmount && (
                  <p className="text-xs font-bold mt-2 opacity-80 italic">
                    Up to {promotion.maxDiscountAmount.toLocaleString()} VND
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-bold">
                  {promotion.usedCount} People Used
                </p>
              </div>
            </div>
          </div>
          ...
          {promotion.appliedTours && promotion.appliedTours.length > 0 ? (
            <div className="flex flex-col">
              {promotion.appliedTours.map((tour) => (
                <div
                  key={tour.id}
                  className="flex items-center justify-between p-6 hover:bg-gray-50 transition-all rounded-3xl group border-b border-gray-50 last:border-0"
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-400 text-xs italic">
                        ID: #{tour.id}
                      </p>
                    </div>
                  </div>
            ...
            <div className="p-20 text-center">
              ...
              <p className="text-gray-500 max-w-sm mx-auto font-medium">
                This code is applicable to all eligible tours across the
                Danatour platform.
              </p>
            </div>
          )}
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
            {loadingUsages ? (
              ...
              <div className="p-20 text-center">
                ...
                <h3 className="text-xl font-black mb-2 text-gray-400">
                  No redemptions yet
                </h3>
