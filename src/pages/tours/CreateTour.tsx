...
const CreateTour: React.FC = () => {
    ...
    // Dynamic Lists State
    const [schedules, setSchedules] = useState<{ startDate: string; endDate: string; capacity: number }[]>([]);
        ...
        <div className="min-h-screen bg-background pb-20">
            ...
            <main className="pt-24 md:pt-32 px-4 md:px-6 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-black tracking-tighter">Create New <span className="text-primary">Tour</span></h1>
                        <p className="text-gray-500 mt-2">Fill in the details to list your new journey</p>
                    </div>
                    <button
                    ...
                    >
                        {loading ? "Creating..." : <><Save size={20} /> Save Tour</>}
                    </button>
                </div>
                ...
                <form id="create-tour-form" onSubmit={handleSubmit} className="space-y-10">
                    {/* Basic Info Section */}
                    ...
                    <section className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-black/5 space-y-8">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-black uppercase tracking-widest text-gray-400">Day-by-day Plan</label>
                            <textarea
                                required
                                rows={10}
                                value={itinerary}
                    ...
                    <section className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-black/5 space-y-8">
                        ...
                        <p className="text-xs text-gray-400 font-medium">* Upload 1-10 high quality images. First image will be used as thumbnail.</p>
                    </section>
                    ...
                    <div className="pt-10 flex justify-end">
                        ...
                        >
                            {loading ? "Creating..." : <><Save size={24} /> List Your Tour Now</>}
                        </button>
                    </div>
                </form>
            </main>
