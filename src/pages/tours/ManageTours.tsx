...
const ManageTours: React.FC = () => {
    ...
    useEffect(() => {
        ...
        fetchMyTours(providerId);
    }, []);

    const fetchMyTours = async (pid: number) => {
        try {
            setLoading(true);
            const response = await tourService.getTours(1, 50, pid);
        ...
        <div className="min-h-screen bg-background pb-20">
            ...
            <main className="pt-24 md:pt-32 px-4 md:px-6 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-black tracking-tighter">My <span className="text-primary">Tours</span></h1>
                        <p className="text-gray-500 mt-2 font-medium">Manage and monitor your travel offerings</p>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                    {[
                        { label: "Total Tours", value: tours?.length || 0, icon: Package, color: "bg-primary" },
                        { label: "Active Bookings", value: "124", icon: TrendingUp, color: "bg-cta" },
                        { label: "Total Revenue", value: "45.2M", icon: Calendar, color: "bg-black" },
                        { label: "Avg. Rating", value: "4.8", icon: Users, color: "bg-blue-500" },
                    ].map((stat, i) => (
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">Syncing your data...</p>
                    </div>
                ) : error ? (
                    ...
                    <div className="bg-gray-50 p-20 rounded-[3rem] text-center border-2 border-dashed border-gray-200">
                        ...
                        <p className="text-gray-500 mb-8 max-w-md mx-auto">Start listing your amazing tours and reach thousands of travelers looking for their next adventure.</p>
                        <button
                            onClick={() => navigate("/tours/create")}
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-gray-50">
                                        <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-gray-400">Tour Information</th>
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {tours
                                        .filter(tour =>
                                            ...
                                            tour.placeName.toLowerCase().includes(searchQuery.toLowerCase())
                                        )
                                        .map((tour) => (
                                                ...
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-400 font-medium">ID: #{tour.id} • {tour.durationDays}D{tour.durationNights}N</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-6">
